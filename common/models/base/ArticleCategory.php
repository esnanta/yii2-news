...
/**
 * This is the base model class for table "tx_article_category".
 *
 * @property integer $id
...
class ArticleCategory extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\common\models\Article::className(), ['article_category_id' => 'id']);
    }
