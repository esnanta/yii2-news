...
/**
 * This is the base model class for table "t_document_category".
 *
 * @property int        $id
 ...
 */
class DocumentCategory extends BaseActiveRecord
{
    use RelationTrait;
    ...
    public static function find(): DocumentCategoryQuery
    {
        ...
        return $query->where(['t_document_category.deleted_by' => 0]);
    }
}
