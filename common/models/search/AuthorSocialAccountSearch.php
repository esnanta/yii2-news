...
/**
 * AuthorSocialAccountSearch represents the model behind the search form about `common\models\AuthorSocialAccount`.
 */
class AuthorSocialAccountSearch extends AuthorSocialAccount
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AuthorSocialAccount::find();
