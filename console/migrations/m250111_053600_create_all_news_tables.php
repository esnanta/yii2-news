...
class m250111_053600_create_all_news_tables extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('{{%staff}}', [
            ...
            'email' => 'ransatriastaff.uns.ac.id',
            'google_plus' => '',
            'instagram' => '',
            'facebook' => '',
            'twitter' => '',
            'description' => 'Dosen Hubungan Internasional Fakultas Ilmu Sosial dan Ilmu Politik Universitas Sebelas Maret Surakarta',
