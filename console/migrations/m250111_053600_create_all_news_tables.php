...
class m250111_053600_create_all_news_tables extends Migration
{
    public function safeUp()
    {
        ...
        $this->insert('{{%user}}', [
            ...
            'password_hash' => '$2y$12$PwgGv0mvn/G5JBPHCNFN3unbNp9xJAmPulgAhYomXI5UEpkH1YLvO',
        ...
        $this->batchInsert(
            ...
            [
                [4, 1, 2, 3, 1, 'Jalan Sunyi Seorang Seniman', '2025-01-08', 'Jalan_Sunyi_Seorang_Seniman_677df5729a145.png', '/app/yii2-news/admin/images/no-picture-available-icon-1.jpg', 0, 3, '', $currentDateTime, $currentDateTime, 1, 3, '5c5d4f93cd7311efaa70c858c0b7f92f'],
                [5, 1, 2, 1, 1, 'Gambar Article', '2025-01-08', 'Gambar_Article_677df58a659ef.pdf', '/app/yii2-news/admin/images/no-picture-available-icon-1.jpg', 0, 3, '', $currentDateTime, $currentDateTime, 1, 3, '6a8aab6ecd7311efaa70c858c0b7f92f'],
                [6, 1, 2, 2, 1, 'tes pdf', '2025-01-08', 'tes_pdf_677df82133b47.xlsx', '/app/yii2-news/admin/images/no-picture-available-icon-1.jpg', 0, 0, '-', $currentDateTime, $currentDateTime, 1, 0, 'f5995e14cd7411efaa70c858c0b7f92f'],
            ]
        );
