        ...
        Pjax::begin(); echo GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function($model){
                        return Html::a('<span class="glyphicon glyphicon glyphicon-refresh"></span>',
                                Yii::$app->urlManager->createUrl(['/receivable/create','id'=>$model->customer_id ]),
                                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                                Yii::$app->urlManager->createUrl(['customer/view', 'id' => $model->customer_id, 'title'=>$model->customer->title]),
                                [
