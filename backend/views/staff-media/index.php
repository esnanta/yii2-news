 ...
 * @var common\models\StaffMediaSearch $searchModel
 */

$this->title = Yii::t('app', 'Staff Media');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="staff-media-index">
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<i class="fas fa-pencil-alt"></i>',
                            Yii::$app->urlManager->createUrl(['staff-media/view', 'id' => $model->id, 'edit' => 't']),
                            [
                    ...
                    'view' => function ($url, $model) {
                        return Html::a('<i class="fas fa-eye"></i>',
                            Yii::$app->urlManager->createUrl(['staff-media/view', 'id' => $model->id]),
                            [
                                'title' => Yii::t('yii', 'Edit'),
                                'class'=>'btn btn-sm btn-info',
                            ]
