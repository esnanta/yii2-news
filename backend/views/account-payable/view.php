    ...
    <?php
        if($providerAccountPayableDetail->totalCount){
            ...
            echo Gridview::widget([
                ...
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-tx-account-payable-detail']],
                'panel' => [
                    'type' => GridView::TYPE_PRIMARY,
                    'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Account Payable Detail'),
                ],
