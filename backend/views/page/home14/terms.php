...
//GOLOBAL PARAM
$logoTop            = Page::getByToken(Yii::$app->params['ThemeDetailToken_Logo1']);
$logoDown           = Page::getByToken(Yii::$app->params['ThemeDetailToken_Logo2']);
$description        = Page::getByToken(Yii::$app->params['ThemeDetailToken_Description']);
$keyword            = Page::getByToken(Yii::$app->params['ThemeDetailToken_Keyword']);

//LOCAL PARAM
$layerNR1           = Page::findOne(['token'=>'101']);
$layerNR2           = Page::findOne(['token'=>'102']);
$layerNR3           = Page::findOne(['token'=>'103']);
$layerNR4           = Page::findOne(['token'=>'104']);
$layerNR5           = Page::findOne(['token'=>'105']);
$layerNR6           = Page::findOne(['token'=>'106']);
$layerNR7           = Page::findOne(['token'=>'107']);
$layerNR8           = Page::findOne(['token'=>'108']);

$iconBlock1         = Page::findOne(['token'=>'115']);
$iconBlock2         = Page::findOne(['token'=>'116']);
$iconBlock3         = Page::findOne(['token'=>'117']);

$aboutOurCompany    = Page::findOne(['token'=>'109']);
$ourRecentProject   = Page::findOne(['token'=>'110']);
$ourLatestNews      = Page::findOne(['token'=>'111']);
