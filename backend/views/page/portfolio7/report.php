...
//PORTFOLIO7 REPORT
$logoReport1        = Page::getByToken(Yii::$app->params['ContentToken_LogoReport_1']);
$logoReport2        = Page::getByToken(Yii::$app->params['ContentToken_LogoReport_2']);
$descReport         = Page::getByToken(Yii::$app->params['ContentToken_DescReport']);
