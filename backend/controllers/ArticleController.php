...
class ArticleController extends Controller
{
    ...
    {
        $model = $this->findModel($id);
        $model->publish_status = (Article::PUBLISH_STATUS_NO == $model->publish_status)
    ...
    {
        $model = $this->findModel($id);
        $model->pinned_status = (Article::PINNED_STATUS_NO == $model->pinned_status)
    ...
    private function validateAndSave(Article $model): Response
    {
        ...
        $model->content = ContentHelper::cleanHtmlContent($model->content);
