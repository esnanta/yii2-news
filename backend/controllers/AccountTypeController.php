...
class AccountTypeController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('index-account-type')){
    ...
    {
        if(Yii::$app->user->can('view-account-type')){
    ...
    {
        if(Yii::$app->user->can('create-account-type')){
    ...
    {
        if(Yii::$app->user->can('update-account-type')){
            $model = $this->findModel($id);
    ...
    public function actionDelete($id)
    {
        ...
        if(Yii::$app->user->can('delete-account-type')){
