...
<?php 
    ...
    echo PaceWidget::widget([
        'color'=>Yii::$app->params['Pace-Color'],
        'theme'=>Yii::$app->params['Pace-Theme'],
        'options'=>[
...
//                    } 
    ...
    <section class="content">
        ...
        <?php foreach (Yii::$app->session->getAllFlashes() as $message):; ?>
            <?php
                echo \kartik\widgets\Growl::widget([
                    ...
                    'title' => (!empty($message['title'])) ? Html::encode($message['title']) : Yii::$app->name,
        ...
        <?php Yii::$app->getSession()->removeAllFlashes(); ?>
        ...
        <?php 
                  ...
                  echo Html::a('<h3>Relogin</h3>', ['user/login']) ;
                }
        ?>
    </section>
</div>
