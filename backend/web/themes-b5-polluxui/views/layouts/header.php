...
<header id="js-header" class="u-header u-header--sticky-top">
    <div class="u-header__section u-header__section--admin-dark g-min-height-65">
        <nav class="navbar no-gutters g-pa-0">
            ...
            <?php 
                $home = str_replace('admin/', '', Yii::$app->urlManager->createAbsoluteUrl('site/index'));
            ?>

                <!-- Logo -->
                <a href="<?= $home ;?>" class="navbar-brand d-flex align-self-center g-hidden-xs-down g-line-height-1 py-0 g-mt-5">
