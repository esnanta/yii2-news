...
/**
 * backend\models\AccountReceivableSearch represents the model behind the search form about `backend\models\AccountReceivable`.
 */
 class AccountReceivableSearch extends AccountReceivable
{
    ...
    {
        return [
            [['id', 'staff_id', 'date_issued', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted', 'deleted_at', 'deleted_by', 'verlock'], 'integer'],
    ...
    {
        $query = AccountReceivable::find()->orderBy(['date_issued'=>SORT_DESC]);
