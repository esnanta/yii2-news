...
/**
 * This is the base model class for table "tx_service".
 *
 * @property integer $id
...
class Service extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['customer_id', 'staff_id', 'date_issued', 'date_effective', 'service_type', 'date_start', 'date_end', 'billing_cycle', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted', 'deleted_at', 'deleted_by', 'verlock'], 'integer'],
            [['description'], 'string'],
            [['claim', 'surcharge', 'total'], 'number'],
    ...
    {
        return $this->hasMany(\backend\models\ServiceDetail::className(), ['service_id' => 'id']);
    }
