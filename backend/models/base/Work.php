...
/**
 * This is the base model class for table "tx_work".
 *
 * @property integer $id
 ...
 *
 * @property \backend\models\WorkType $workType
...
class Work extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasOne(\backend\models\WorkType::className(), ['id' => 'work_type_id']);
    }
    ...
    {
        return $this->hasMany(\backend\models\WorkRequestDetail::className(), ['work_id' => 'id']);
    }
