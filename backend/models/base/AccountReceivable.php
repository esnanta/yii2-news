...
/**
 * This is the base model class for table "tx_account_receivable".
 *
 * @property integer $id
...
class AccountReceivable extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\backend\models\AccountReceivableDetail::className(), ['account_receivable_id' => 'id']);
    }
