...
/**
 * This is the base model class for table "tx_receivable".
 *
 * @property integer $id
...
class Receivable extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\backend\models\ReceivableDetail::className(), ['receivable_id' => 'id']);
    }
