...
/**
 * This is the base model class for table "tx_validity".
 *
 * @property integer $id
 ...
 */
class Validity extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\backend\models\ValidityDetail::className(), ['validity_id' => 'id']);
    }
