...
/**
 * This is the base model class for table "tx_account_payable".
 *
 * @property integer $id
...
class AccountPayable extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\backend\models\AccountPayableDetail::className(), ['account_payable_id' => 'id']);
    }
