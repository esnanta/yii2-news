...
use \backend\models\base\Account as BaseAccount;

/**
 * This is the model class for table "tx_account".
 */
class Account extends BaseAccount
{
    ...
    public function attributeLabels()
    {
        return [
            'id'                => 'ID',
            'account_type_id'   => Yii::$app->params['Attribute_Type'],
    ...
    public function getUrl(){
        return Yii::$app->getUrlManager()->createUrl(['account/view', 'id' => $this->id, 'title' => $this->title]);
    }      
