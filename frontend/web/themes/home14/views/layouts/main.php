...
use frontend\assets\Home14Asset;
            ...
            <nav class="js-mega-menu navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a href="../../index.html" class="navbar-brand">                        
                        <?php //echo Html::img('@web/themes/home14/img/logo/logo-1.png', ['alt'=>'Image Description', 'class'=>'thing']) ?>
                        <?= str_replace('user/', '', Html::a($logo1Image, ['site/index'], ['class' => 'thing'])); ?>
                    </a>
                    <!-- End Logo -->
                    ...
                    <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg" id="navBar">
                        <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                            ...
                            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                                <?= Html::a('Portfolio', ['portfolio/index'], ['class' => 'nav-link g-py-7 g-px-0']) ?>
                            </li>                             
                            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                                <?= Html::a('Blog', ['blog/index'], ['class' => 'nav-link g-py-7 g-px-0']) ?>
                            </li>                            
                            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                                <?= Html::a('Terms', ['site/terms'], ['class' => 'nav-link g-py-7 g-px-0']) ?>
                            </li>                      
                            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                                <?= Html::a('About', ['site/about'], ['class' => 'nav-link g-py-7 g-px-0']) ?>
                            </li>
                            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                                <?= Html::a('Contact', ['site/contact'], ['class' => 'nav-link g-py-7 g-px-0']) ?>
                            </li>
                            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                                <?php
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <address class="g-bg-no-repeat g-font-size-12 mb-0" style="background-image: url(<?php echo Yii::$app->urlManager->baseUrl .'/themes/home14/img/maps/map2.png'?>)">
                        <!-- Location -->
                        ...
                        <div class="d-flex g-mb-20">
                            ...
                            <p class="mb-0"><?php echo $office->phone_number;?> <br> <?php echo 'Fax '.$office->fax_number;?></p>
                        </div>
                        <!-- End Phone -->
                        ...
                        <div class="d-flex g-mb-20">
                            ...
                            <p class="mb-0">
                                <a class="g-color-white-opacity-0_8 g-color-white--hover" href="mailto:info@htmlstream.com"><?php echo $office->email;?></a>
                                <br>
                                <a class="g-color-white-opacity-0_8 g-color-white--hover" href="#"><?php echo $office->web;?></a>
                            </p>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 text-center text-md-left g-mb-10 g-mb-0--md">
                    <div class="d-lg-flex">
                        <small class="d-block g-font-size-default g-mr-10 g-mb-10 g-mb-0--md"><?= date('Y') ?> © <?php echo Yii::$app->params['Copyright']; ?>.</small>
