                ...
                <ul>
                    ...
                    <li data-index="rs-74" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-74-layer-1"
                            ...
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                            style="z-index: 5;">
                            <img src="../../assets/img-temp/900x600/img6.jpg" alt=""
                                data-ww="['1000px','1000px','800px','500px']"
                                data-hh="['563px','563px','450px','281px']" width="1200" height="675" data-no-retina>
                        </div>

                        <!-- LAYER NR. 6 -->
                        <div class="tp-caption rev-btn  tp-resizeme" id="slide-74-layer-4"
        ...
        <div id="rev_slider_26_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;" data-version="5.4.1">
            <ul>
                ...
                <li data-index="rs-73" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"
                    ...
                    <!-- MAIN IMAGE -->
<!-- MISSING ASSET -->                     
                    <img src="../../web/themes/home14/img/bg/transparent2.png" data-bgcolor='linear-gradient(90deg, rgba(0, 0, 153, 0.5) 0%, rgba(0, 190, 214, 0.6) 100%)' style='background:linear-gradient(90deg, rgba(0, 0, 153, 0.5) 0%, rgba(0, 190, 214, 0.6) 100%)' alt="" data-bgposition="center center"
...
<!-- MISSING ASSET --> 
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-2" id="slide-73-layer-1" data-x="['center','center','center','center']" data-hoffset="['500','500','390','220']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']" data-width="none"
                        ...
                        <img src="<?php echo str_replace('frontend', 'backend', $layerNR2->getImageUrl())  ;?>" alt="" data-ww="['1000px','1000px','800px','500px']" data-hh="['563px','563px','450','281']" width="1200" height="675" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-73-layer-3" data-x="['left','left','left','left']" data-hoffset="['150','100','50','20']" data-y="['middle','middle','middle','middle']" data-voffset="['-177','-177','-177','-157']" data-width="none" data-height="none"
                         ...
                         data-textAlign="['left','left','left','left']" data-paddingtop="[10,10,10,10]" data-paddingright="[20,20,20,20]" data-paddingbottom="[10,10,10,10]" data-paddingleft="[20,20,20,20]" style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #ffffff; letter-spacing: 10px;">
                        <?php echo $layerNR3->content;?>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-73-layer-2" data-x="['left','left','left','left']" data-hoffset="['150','100','50','20']" data-y="['middle','middle','middle','middle']" data-voffset="['-30','-30','-30','-30']" data-fontsize="['70','70','70','50']"
                         ...
                         data-textAlign="['left','left','left','left']" data-paddingtop="[20,20,20,20]" data-paddingright="[20,20,20,20]" data-paddingbottom="[30,30,30,30]" data-paddingleft="[20,20,20,20]" style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; font-weight: 600; line-height: 70px; color: #ffffff; letter-spacing: -2px;">
                        <?php echo $layerNR4->content;?>
                    </div>
                </li>
                <!-- SLIDE  -->
...
<!-- MISSING ASSET -->                    
                    <img src="../../web/themes/home14/img/bg/transparent2.png" data-bgcolor='linear-gradient(120deg, #b7ebf6 0%, rgba(228, 97, 210, 0.7) 100%)' style='background:linear-gradient(120deg, #b7ebf6 0%, rgba(228, 97, 210, 0.7) 100%)' alt="" data-bgposition="center center"
                         data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
<!-- MISSING ASSET -->        
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-74-layer-1" data-x="['center','center','center','center']" data-hoffset="['-500','-500','-390','-220']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                        ...
                        <img src="<?php echo str_replace('frontend', 'backend', $layerNR5->getImageUrl());?>" alt="" data-ww="['1000px','1000px','800px','500px']" data-hh="['563px','563px','450px','281px']" width="1200" height="675" data-no-retina>
                    </div>

                    <!-- LAYER NR. 6 -->
                    <!-- OKE         -->
                    <div class="tp-caption rev-btn  tp-resizeme" id="slide-74-layer-4" data-x="['left','left','left','left']" data-hoffset="['880','760','600','330']" data-y="['middle','middle','middle','middle']" data-voffset="['150','150','150','110']" data-width="none"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-74-layer-3" data-x="['left','left','left','left']" data-hoffset="['820','700','540','270']" data-y="['middle','middle','middle','middle']" data-voffset="['-177','-177','-177','-157']" data-width="none" data-height="none"
                         ...
                         data-textAlign="['left','left','left','left']" data-paddingtop="[10,10,10,10]" data-paddingright="[20,20,20,20]" data-paddingbottom="[10,10,10,10]" data-paddingleft="[20,20,20,20]" style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #ffffff; letter-spacing: 10px;">
                        <?php echo $layerNR7->content;?>
                    </div>

                    <!-- LAYER NR. 8 -->
                    <div class="tp-caption   tp-resizeme" id="slide-74-layer-2" data-x="['left','left','left','left']" data-hoffset="['360','240','110','80']" data-y="['middle','middle','middle','middle']" data-voffset="['-30','-30','-30','-30']" data-fontsize="['70','70','70','50']"
        ...
        <div class="row no-gutters">
            <div class="col-lg-4 g-px-40 g-mb-50 g-mb-0--lg">
                ...
                <div class="text-center">
                    ...
                    <h3 class="h5 g-color-gray-dark-v2 g-font-weight-600 text-uppercase mb-3"><?= $iconBlock1->title;?></h3>
                    <p class="mb-0"><?= $iconBlock1->content;?></p>
                </div>
                <!-- End Icon Blocks -->
            </div>
            ...
            <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40 g-mb-50 g-mb-0--lg">
                ...
                <div class="text-center">
                    ...
                    <h3 class="h5 g-color-gray-dark-v2 g-font-weight-600 text-uppercase mb-3"><?= $iconBlock2->title;?></h3>
                    <p class="mb-0"><?= $iconBlock2->content;?></p>
                </div>
                <!-- End Icon Blocks -->
            </div>
            ...
            <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40">
                ...
                <div class="text-center">
                    ...
                    <h3 class="h5 g-color-gray-dark-v2 g-font-weight-600 text-uppercase mb-3"><?= $iconBlock3->title;?></h3>
                    <p class="mb-0"><?= $iconBlock3->content;?></p>
                </div>
                <!-- End Icon Blocks -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center g-mb-100 g-mb-0--lg">
                <header class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                    <h2 class="h4 u-heading-v2__title g-color-gray-dark-v2 g-font-weight-600 text-uppercase"><?=$aboutOurCompany->title;?></h2>
                </header>

                <p class="g-font-size-16 g-mb-30"><?=$aboutOurCompany->description;?></p>

                <?=$aboutOurCompany->content;?>
            ...
            <div class="col-lg-6 g-bg-img-hero g-pos-rel">
                <div class="g-absolute-centered text-center w-100 g-px-40">
                    ...
                    <?php
                        $image = str_replace('frontend', 'backend', $aboutOurCompany->getImageUrl());
    ...
    <div class="container">
        <header class="g-mb-50">
            <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                <h2 class="h4 u-heading-v2__title g-color-gray-dark-v2 g-font-weight-600 text-uppercase"><?=$ourRecentProject->title;?></h2>
            </div>
            <p class="g-font-size-16"><?=$ourRecentProject->content;?></p>
        </header>
...
<section class="g-py-100">
    <div class="container">
        <header class="g-mb-50">
            <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                <h2 class="h4 u-heading-v2__title g-color-gray-dark-v2 g-font-weight-600 text-uppercase"><?=$ourLatestNews->title;?></h2>
            </div>
            <p class="g-font-size-16"><?=$ourLatestNews->content;?></p>
        </header>
