...
<?php
    $img = Html::img(str_replace('frontend', 'backend', $model->getImageUrl()), ['class'=>'img-responsive img-bordered full-width','style'=>'width:250px;height:250px'],['alt' => 'alt image']);
?>
...
<div class="row">
    ...
    <div class="col-lg-3 g-mb-50 g-mb-0--lg">
        ...
        <div class="u-block-hover g-pos-rel g-brd-around g-brd-gray-light-v4">
            <figure>
                <?=
                    Html::img(str_replace('frontend', 'backend', $model->getImageUrl()),
