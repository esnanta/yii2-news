...
$articleCover   = str_replace('frontend', 'backend', ContentHelper::getCover($model->content));
...
<span itemprop="image" itemscope itemtype="image/jpeg"> 
    <link itemprop="url" href=<?='https://'.Yii::$app->request->serverName.$articleCover;?>>
</span>
...
<article class="g-mb-60">
    ...
    <div class="g-mb-30">
        <h6 class="g-color-gray-dark-v1">
            ...
            <?php
                $styleClass = 'u-tags-v1 g-font-size-12 g-brd-around g-brd-gray-light-v4 g-bg-primary--hover 
                                    g-brd-primary--hover g-color-black-opacity-0_8 g-color-white--hover 
                                    rounded g-py-6 g-px-15 g-mr-5';
                $tags       = $model->tags;
