...
<div class="document-view">
    <div class="card">
        <div class="card-header">
            <h1 class="card-title h2"><?= Html::encode($this->title) ?></h1>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer text-muted">
            <?= Html::a(FAS::icon('download') . ' Download', $documentUrl, ['class' => 'btn btn-primary', 'target' => '_blank', 'rel' => 'noopener noreferrer']) ?>
        </div>
    </div>
</div>
